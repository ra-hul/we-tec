...
<body>
	<table border="1" width="100%" cellspacing="0">
		...
		<tr height = "200px">
			...
			<td colspan="2">
                <h1>Select Category and write down your desire rare medicine</h1>
                <h3>You will get your product within 72 hours</h3>
				<form method="post" action="../controller/checkReqmed.php" onsubmit="return validateform()">
